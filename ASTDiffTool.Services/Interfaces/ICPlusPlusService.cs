...
namespace ASTDiffTool.Services.Interfaces
{
    ...
    public interface ICPlusPlusService
    {
        ...
        /// </returns>
        Task<bool> RunASTDumpToolAsync(string compilationDatabasePath, string mainPath, string projectName, string firstStandard, string secondStandard);
        ...
        /// </returns>
        Task<bool> RunComparerToolAsync(string firstStandrd, string secondStandrd);
    }
}